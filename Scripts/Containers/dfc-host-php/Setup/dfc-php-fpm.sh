...
docker-compose -p $dfc_global__project_name exec -u root dfc-host-php ash -c "apk add php81-fpm" >&1

(cd $dfc_project_main_folder/Scripts/Containers/dfc-host-php/Services/Enable && sh dfc-php-fpm.sh -d1) >&3

message_info "В контейнере 'dfc-host-php' установлен пакет 'php81-fpm' и готов к работе" 1
