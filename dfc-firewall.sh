...
"1")
    ...
    "1")
        ...
        (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-php/Firewall && sh dfc-info.sh -d1) >&3
        ;;
    "2")
        message_space 1
    ...
    "3")
        ...
        (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-php/Firewall/Unblock && sh dfc-incoming.sh -d1) >&3
        ;;
    "4")
        message_space 1

        (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-php/Firewall/Block && sh dfc-incoming.sh -d1) >&3
        ;;
    "5")
        message_space 1

        (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-php/Firewall/Unblock && sh dfc-outcoming.sh -d1) >&3
        ;;
    "6")
        message_space 1

        (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-php/Firewall/Block && sh dfc-outcoming.sh -d1) >&3
        ;;
    "7")
        message_space 1
    ...
    "9")
        ...
        (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-php/Firewall/Unblock && sh dfc-ip-custom.sh -d1) >&3
        ;;
    "10")
        message_space 1

        (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-php/Firewall/Block && sh dfc-ip-custom.sh -d1) >&3
        ;;
    "11")
        message_space 1

        (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-php/Firewall/Unblock && sh dfc-port-443.sh -d1) >&3
        ;;
    "12")
        message_space 1

        (cd $dfc_project_main_folder/Scripts/Containers/dfc-host-php/Firewall/Block && sh dfc-port-443.sh -d1) >&3
        ;;
    "13")
        . $dfc_project_main_folder/Scripts/Dependencies/dfc-message-exit.sh >&3
        ;;
